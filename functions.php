...
function theme_files()
{
    ...
    wp_enqueue_script( 'bootstrap-js', 'https://cdn.jsdelivr.net/npm/bootstrap@5.1.1/dist/js/bootstrap.bundle.min.js', array( 'jquery' ), true, true );
...
function custom_widgets() {
  ...
  register_sidebar( array(
		'name'          => 'WP Widget Bootstrap Card',
		'id'            => 'wp_widget_bootstrap_card',
		'before_widget' => '<div class="col-lg-3 col-md-6 col-sm"><div class="cardWidget small">',
